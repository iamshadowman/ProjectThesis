...
for j = 1: n
    ...
    %Phonon creation at the site right to the electron and check
    ...
    %Phonon annihilation at the site right to the electron and check
    ...
    %Phonon creation at the site left to the electron and check
    ...
    %Phonon annihilation at the site left to the electron and check
...
data=[tp_ks', p1_ks', p2_ks', p3_ks', c1', c2', c3', c4', c5', c6', c7', c8']
%writematrix(data, 'h3kmap.txt')
